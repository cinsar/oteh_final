...
ActiveRecord::Schema.define(version: 20140717014755) do
  ...
  add_index "users", ["authenticable_id", "authenticable_type"], name: "index_users_on_authenticable_id_and_authenticable_type", using: :btree
